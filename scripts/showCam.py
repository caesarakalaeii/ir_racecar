...
async def main():
    ...
    cam_button = Button(root, text="Show Feed", command=showCam)
    transform_button = Button(root, text="Show Transformed", command=showTrans)
    diff_button = Button(root, text="Show Difference", command=showDiff)
    diffTrans_button = Button(root, text="Show Difference", command=showTransDiff)
    cannytrans_button = Button(root,  text="Show Transformed Canny", command=showCannyTrans)
    canny_button = Button(root,  text="Show Transformed Canny", command=showCanny)
